...
//       <div className=" rounded-lg w-full max-w-md p-5 relative">
//         {/* Close button */}
//         <button
//           onClick={onClose}
...
//       <div className="rounded-lg w-full max-w-md p-5 relative bg-white shadow-lg">
//         {/* Close button */}
//         <button
//           onClick={onClose}
...
//                   value={feedbackType}
//                   onChange={(e) => setFeedbackType(e.target.value)}
//                   className="w-full bg-white border border-gray-300 rounded-md py-2 px-3 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500"
//                 >
//                   <option value="general">General Feedback</option>
//                   <option value="bug">Report a Bug</option>
//                   <option value="feature">Feature Request</option>
...
//                       <svg 
//                         xmlns="http://www.w3.org/2000/svg" 
//                         className={`h-8 w-8 ${rating >= star ? 'text-yellow-400' : 'text-gray-400'}`}
//                         viewBox="0 0 20 20" 
//                         fill="currentColor"
//                       >
//                         <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
...
//                   value={feedbackText}
//                   onChange={(e) => setFeedbackText(e.target.value)}
//                   className="w-full bg-white border border-gray-300 rounded-md py-2 px-3 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 min-h-24"
//                   placeholder="What's working well? What could be improved?"
//                   required
//                 ></textarea>
//               </div>

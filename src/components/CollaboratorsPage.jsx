...
// const CollaboratorCard = ({ collaborator, onRemove, onViewProfile, onRequestCollab }) => (
//   <div className="bg-gray-800 p-5 rounded-lg group hover:bg-gray-750 transition-all duration-300 border border-transparent hover:border-indigo-500 shadow-lg">
//     <div className="flex justify-between items-start">
//       <div className="flex items-center">
...
//         <label className="block text-sm font-medium text-gray-400 mb-1">Institution</label>
//         <select
//           className="w-full bg-gray-800 text-white p-2 rounded-lg border border-gray-700 focus:outline-none focus:border-indigo-500"
...
//     <div className="bg-gray-800 rounded-lg p-6 max-w-lg w-full max-h-screen overflow-y-auto">
...
//                   className={`px-3 py-2 flex items-center ${viewMode === "grid" ? "bg-indigo-700" : "bg-gray-800 hover:bg-gray-700"}`}
//                 >
...
//                   className={`px-3 py-2 flex items-center ${viewMode === "list" ? "bg-indigo-700" : "bg-gray-800 hover:bg-gray-700"}`}
//                 >
//                   <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
//           {showAddForm && (
//             <div className="bg-gray-800 p-6 rounded-lg mb-6 border border-indigo-900/30 shadow-lg">
//               <div className="flex justify-between items-start mb-4">
...
//           {viewMode === "list" && (
//             <div className="bg-gray-800 rounded-t-lg p-3 grid grid-cols-12 gap-2 font-medium text-gray-400 text-sm border-b border-gray-700">
//               <div 
...
//               </div>
//             ) : (
//               <div className="bg-gray-800 rounded-b-lg mb-4">
//                 {filteredCollaborators.map((collaborator, idx) => (
//                   <div 
//                     key={idx} 
...
//                 <button className="px-2 py-1 rounded bg-gray-800 hover:bg-gray-700 transition-colors">
//                   1
//                 </button>
//                 <span>of 1</span>
//               </div>

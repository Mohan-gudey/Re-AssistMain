...
//               transition={{ duration: 0.6 }}
//               viewport={{ once: true }}
//               className=" rounded-xl shadow-lg overflow-hidden border border-gray-700 p-6"
//             >
...
//       <div className="container mx-auto px-4 sm:px-6 lg:px-8">
//         <div className="text-center mb-16">
//           <h2 className="text-3xl font-bold text-gray-800 mb-4">Research & Academia</h2>
...
//               <div 
//                 className="h-64 lg:h-96 w-full bg-cover bg-center rounded-xl" 
//                 style={{ backgroundImage: `url('/src/assets/ReAssist.jpg')` }}
//               ></div>
//             </div>
//           </motion.div>
...
//               className=" rounded-xl shadow-lg overflow-hidden border border-gray-700 p-6"
//             >
//               <h3 className="text-2xl font-semibold text-gray-800 mb-6">Transforming Academic Workflows</h3>
...
//                     </div>
//                     <div>
//                       <h4 className="text-lg font-medium text-gray-600 mb-1">{feature.title}</h4>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-center">
          <motion.div 
            ...
            className="lg:w-1/2"
          >
            <div className="bg-gradient-to-br from-blue-100 to-indigo-100 p-1 rounded-xl shadow-lg">
              <div 
                className="h-64 lg:h-96 w-full bg-cover bg-center rounded-xl" 
                style={{ backgroundImage: `url('/src/assets/ReAssist.jpg')` }}
              ></div>
          ...
          <div className="lg:w-1/2">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="rounded-xl shadow-lg overflow-hidden border border-gray-300 p-6"
            >
              <h3 className="text-2xl font-semibold text-gray-800 mb-6">Transforming Academic Workflows</h3>
        ...
        <motion.div
          ...
          className="mt-16 text-center"
        >
          {/* <h3 className="text-2xl font-semibold text-gray-800 mb-6">Trusted by leading academic institutions</h3>
          <div className="flex flex-wrap justify-center gap-8 opacity-60">
            <div className="w-32 h-12 bg-gray-500 rounded"></div>
            <div className="w-32 h-12 bg-gray-500 rounded"></div>
            <div className="w-32 h-12 bg-gray-500 rounded"></div>

...
//                   </div>
//                   <div>
//                     <h3 className="font-semibold text-gray-800">Re-Assistant</h3>
//                     <p className="text-xs text-gray-600">Online • Prompt response</p>
//                   </div>
//                 </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-10">
          <div className="lg:w-1/2 relative z-10">
            ...
            >
              <h1 className="text-4xl sm:text-5xl font-bold text-gray-800 mb-6">
                The AI Assistant That <span className="text-blue-600">Revolutionizes</span> Your Work
              </h1>
              <p className="text-xl text-gray-700 mb-8">
                Re-Assist helps you automate tasks, analyze data, and generate insights faster than ever before.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button 
          ...
          <div className="lg:w-1/2">
            <motion.div
              ...
              className="rounded-2xl shadow-xl p-4 sm:p-6 relative overflow-hidden"
            >
              <div className="relative z-10 p-4 rounded-xl border border-gray-200">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center mr-3">
                    <FaRobot className="text-white" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-800">Re-Assist</h3>
                    <p className="text-xs text-gray-500">Online • Prompt response</p>
                  </div>
                </div>

                <div className="border-t border-gray-200 pt-4">
                  <div className="bg-gray-100 p-3 rounded-lg rounded-tl-none inline-block mb-3">
                    <p className="text-sm text-gray-800">How can I analyze this dataset to find key trends?</p>
                  </div>
                  
                  <div className="bg-blue-100 p-3 rounded-lg rounded-tr-none inline-block ml-auto mb-3">
                    <p className="text-sm text-gray-800">I'll help you analyze that. First, let's identify the main variables and their relationships. Then we can visualize the key trends using time series analysis.</p>
                  </div>
                  
                  <div className="bg-blue-100 p-3 rounded-lg rounded-tr-none inline-block ml-auto">
                    <p className="text-sm text-gray-800">Here's a summary of the top 3 trends I've identified:</p>
                ...
                <div className="mt-4 relative">
                  <input 
                    type="text" 
                    placeholder="Ask me anything..."
                    className="w-full p-3 pr-10 bg-gray-100 border border-gray-300 text-gray-800 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all placeholder-gray-500"
                  />
                  <button className="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-600 hover:text-blue-500">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.707l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L9 9.414V13a1 1 0 102 0V9.414l1.293 1.293a1 1 0 001.414-1.414z" clipRule="evenodd" />
                    </svg>
                  </button>

            ...
            {showInput && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
                <div className="bg-white rounded-lg p-6 w-full max-w-5xl shadow-lg border border-blue-200">
                  <h2 className="text-lg font-semibold text-blue-700 mb-2">Create New Project</h2>

                  <label className="block text-sm font-medium text-blue-600 mb-1">Project Title</label>
                  <input
